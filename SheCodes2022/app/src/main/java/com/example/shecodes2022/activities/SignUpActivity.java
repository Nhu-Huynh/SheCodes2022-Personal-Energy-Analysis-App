...
import com.example.shecodes2022.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        user.put(Constants.KEY_USER_POINT, String.valueOf(0));
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference ->  {
                    ...
                    preferenceManager.putInteger(Constants.KEY_USER_POINT, 0);
